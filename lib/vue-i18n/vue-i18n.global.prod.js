...
var VueI18n = function(e, t) {
    "use strict";
    const n = "function" == typeof Symbol && "symbol" == typeof Symbol.toStringTag,
        r = e => n ? Symbol(e) : e,
        a = e => JSON.stringify(e).replace(/\u2028/g, "\\u2028").replace(/\u2029/g, "\\u2029").replace(/\u0027/g, "\\u0027"),
        o = e => "number" == typeof e && isFinite(e),
        s = e => "[object RegExp]" === _(e),
        l = e => v(e) && 0 === Object.keys(e).length;
        ...
        for (const t in e)
            if (m(e, t))
                if (t.includes(".")) {
                    ...
                    a[n[r]] = e[t], delete e[t], h(a[n[r]]) && P(a[n[r]])
                } else h(e[t]) && P(e[t]);
        return e
    }
    const C = e => e,
        M = e => "",
        $ = e => 0 === e.length ? "" : e.join(""),
        O = e => null == e ? "" : p(e) || v(e) && e.toString === k ? JSON.stringify(e, null, 2) : String(e);
    ...
    function W(e = {}) {
        const t = e.locale,
            ...
            r = h(e.pluralRules) && d(t) && g(e.pluralRules[t]) ? e.pluralRules[t] : I,
            a = h(e.pluralRules) && d(t) && g(e.pluralRules[t]) ? I : void 0,
            s = e.list || [],
            l = e.named || {};
        ...
        function c(t) {
            const n = g(e.messages) ? e.messages(t) : !!h(e.messages) && e.messages[t];
            return n || (e.parent ? e.parent.message(t) : M)
        }
        const u = v(e.processor) && g(e.processor.normalize) ? e.processor.normalize : $,
            ...
            f = {
                ...
                linked: (t, n) => {
                    const r = c(t)(f);
                    return d(n) ? (a = n, e.modifiers ? e.modifiers[a] : C)(r) : r;
                    var a
                },
                message: c,
                type: v(e.processor) && d(e.processor.type) ? e.processor.type : "text",
                interpolate: i,
                normalize: u
            };
        return f
    ...
    function D(e) {
        ...
        let n = 0,
            ...
            a = 1,
            o = 0;
        const s = e => "\r" === t[e] && t[e + 1] === j,
            l = e => t[e] === R,
            c = e => t[e] === H,
            u = e => s(e) || (e => t[e] === j)(e) || l(e) || c(e),
            i = e => s(e) || l(e) || c(e) ? j : t[e];
    ...
    function U(e, t = {}) {
        ...
        function g(e) {
            let t = "";
            for (; e.currentPeek() === E || e.currentPeek() === j;) t += e.currentPeek(), e.peek();
            return t
        }
        ...
        function C(e, t) {
            ...
            switch (e.currentChar()) {
                ...
                default:
                    ...
                    if (a = h(e, t)) return n = f(t, 6, function(e) {
                        d(e);
                        let t = "";
                        return "-" === e.currentChar() ? (e.next(), t += `-${w(e)}`) : t += w(e), e.currentChar() === A && o(), t
                    }(e)), d(e), n;
                    if (s = function(e, t) {
                            const {
                                currentType: n
                        ...
                        let t = "",
                            n = "";
                        const r = e => "'" !== e && e !== j;
                        for (; t = v(e, r);) n += "\\" === t ? T(e) : t;
                        const a = e.currentChar();
                        return a === j || a === A ? (o(), a === j && (e.next(), p(e, "'")), n) : (p(e, "'"), n)
                    }(e)), d(e), n;
                    if (!r && !a && !s) return n = f(t, 13, function(e) {
                        d(e);
                        let t = "",
                            n = "";
                        const r = e => "{" !== e && "}" !== e && e !== E && e !== j;
                        for (; t = v(e, r);) n += t;
                        return n
                    }(e)), o(), d(e), n
            }
    ...
    const z = /(?:\\\\|\\'|\\u([0-9a-fA-F]{4})|\\U([0-9a-fA-F]{6}))/g;
    ...
    function V(e = {}) {
        ...
        function i(e) {
            ...
            switch (10 !== o.type && q(o), o = e.nextToken(), 2 === o.type && (o = e.nextToken()), o.type) {
                ...
                default:
                    const t = e.context(),
                        u = r(7, t.offset, t.startLoc);
                    return u.value = "", a(u, t.offset, t.startLoc), n.key = u, a(n, t.offset, t.startLoc), {
                        nextConsumeToken: o,
                        node: n
                    }
            }
        ...
        function f(e) {
            ...
            let u = null;
            do {
                const t = u || e.nextToken();
                switch (u = null, t.type) {
                    case 0:
                        null == t.value && q(t), n.items.push(o(e, t.value || ""));
                        break;
                    case 6:
                        null == t.value && q(t), n.items.push(s(e, t.value || ""));
                        break;
                    case 5:
                        null == t.value && q(t), n.items.push(l(e, t.value || ""));
                        break;
                    case 7:
                        null == t.value && q(t), n.items.push(c(e, t.value || ""));
                        break;
                    case 8:
                        const r = i(e);
                        n.items.push(r.node), u = r.nextConsumeToken || null
                }
        ...
        switch (t.type) {
            ...
            case 1:
                ! function(e, t) {
                    ...
                    if (t.cases.length > 1) {
                        ...
                        for (let n = 0; n < a && (K(e, t.cases[n]), n !== a - 1); n++) e.push(", ");
                        e.deindent(r()), e.push("])")
                    }
                }(e, t);
                break;
            case 2:
                ! function(e, t) {
                    ...
                    for (let n = 0; n < a && (K(e, t.items[n]), n !== a - 1); n++) e.push(", ");
                    e.deindent(r()), e.push("])")
                }(e, t);
                break;
            case 6:
                ! function(e, t) {
                    ...
                    e.push(`${n("linked")}(`), K(e, t.key), t.modifier && (e.push(", "), K(e, t.modifier)), e.push(")")
                }(e, t);
                break;
            case 8:
            case 7:
    ...
    function Z(e, t = {}) {
        ...
        return Y(r, n), ((e, t = {}) => {
            ...
            s.push("normal" === n ? "function __msg__ (ctx) {" : "(ctx) => {"), s.indent(a), o.length > 0 && (s.push(`const { ${o.map((e=>`${e}: _${e}`)).join(", ")} } = ctx`), s.newline()), s.push("return "), K(s, e), s.deindent(a), s.push("}");
            const {
                code: l,
                map: c
            } = s.context();
    ...
    function ee(e = {}) {
        const t = d(e.version) ? e.version : "9.1.7",
            n = d(e.locale) ? e.locale : "en-US",
            r = p(e.fallbackLocale) || v(e.fallbackLocale) || d(e.fallbackLocale) || !1 === e.fallbackLocale ? e.fallbackLocale : n,
            a = v(e.messages) ? e.messages : {
                [n]: {}
            },
            o = v(e.datetimeFormats) ? e.datetimeFormats : {
                [n]: {}
            },
            l = v(e.numberFormats) ? e.numberFormats : {
                [n]: {}
            },
            i = u({}, e.modifiers || {}, {
                upper: e => d(e) ? e.toUpperCase() : e,
                lower: e => d(e) ? e.toLowerCase() : e,
                capitalize: e => d(e) ? `${e.charAt(0).toLocaleUpperCase()}${e.substr(1)}` : e
            }),
            f = e.pluralRules || {},
    ...
    function ne(e, t, n) {
        ...
        if (!a) {
            ...
            let e = [n];
            for (; p(e);) e = re(a, e, t);
            const o = p(t) ? t : v(t) ? t.default ? t.default : null : t;
            e = d(o) ? [o] : o, p(e) && re(a, e, !1), r.__localeChainCache.set(n, a)
        }
        return a
    }
    ...
    function fe(e, ...t) {
        const {
            ...
            fallbackLocale: s,
            messages: l
        } = e, [c, u] = pe(...t), f = (b(u.missingWarn), b(u.fallbackWarn), b(u.escapeParameter) ? u.escapeParameter : e.escapeParameter), m = !!u.resolvedMessage, k = d(u.default) || b(u.default) ? b(u.default) ? c : u.default : n ? c : "", _ = n || "" !== k, v = d(u.locale) ? u.locale : e.locale;
        f && function(e) {
            p(e.list) ? e.list = e.list.map((e => d(e) ? i(e) : e)) : h(e.named) && Object.keys(e.named).forEach((t => {
                d(e.named[t]) && (e.named[t] = i(e.named[t]))
            }))
        }(u);
        let [y, F, L] = m ? [c, v, l[v] || {}] : function(e, t, n, r, a, o) {
            const {
                messages: s
            } = e, l = ne(e, r, n);
            let c, u = {},
                i = null;
            const f = "translate";
            for (let n = 0; n < l.length && (c = l[n], u = s[c] || {}, null === (i = x(u, t)) && (i = u[t]), !d(i) && !g(i)); n++) {
                const n = te(e, t, c, 0, f);
                n !== t && (i = n)
            }
            return [i, c, u]
        }(e, c, v, s), w = c;
        if (m || d(y) || ie(y) || _ && (y = k, w = y), !(m || (d(y) || ie(y)) && d(F))) return a ? -1 : c;
        let T = !1;
        const P = ie(y) ? y : me(e, c, F, y, w, (() => {
            T = !0
        }));
        if (T) return y;
    ...
    function me(e, t, n, r, o, s) {
        ...
        const u = l(r, function(e, t, n, r, o, s) {
            return {
                warnHtmlMessage: o,
                onError: e => {
                    throw s && s(e), e
                },
                onCacheKey: e => ((e, t, n) => a({
                    l: e,
                    k: t,
                    s: n
                }))(t, n, e)
    ...
    function pe(...e) {
        const [t, n, r] = e, a = {};
        if (!d(t) && !o(t) && !ie(t)) throw Error(14);
        const s = o(t) ? String(t) : (ie(t), t);
        return o(n) ? a.plural = n : d(n) ? a.default = n : v(n) && !l(n) ? a.named = n : p(n) && (a.list = n), o(r) ? a.plural = r : d(r) ? a.default = r : v(r) && u(a, r), [s, a]
    }
    ...
    function ge(e, ...t) {
        ...
        b(i.fallbackWarn);
        const m = !!i.part,
            p = d(i.locale) ? i.locale : e.locale,
            g = ne(e, a, p);
        if (!d(s) || "" === s) return new Intl.DateTimeFormat(p).format(c);
        let h, k = {},
            _ = null;
        for (let t = 0; t < g.length && (h = g[t], k = n[h] || {}, _ = k[s], !v(_)); t++) te(e, s, h, 0, "datetime format");
        if (!v(_) || !d(h)) return r ? -1 : s;
        let y = `${h}__${s}`;
        l(f) || (y = `${y}__${JSON.stringify(f)}`);
        let F = o.get(y);
    ...
    function de(...e) {
        ...
        return d(n) ? l.key = n : v(n) && (l = n), d(r) ? l.locale = r : v(r) && (c = r), v(a) && (c = a), [l.key || "", s, l, c]
    }
    ...
    function he(e, ...t) {
        ...
        const m = !!i.part,
            p = d(i.locale) ? i.locale : e.locale,
            g = ne(e, a, p);
        if (!d(s) || "" === s) return new Intl.NumberFormat(p).format(c);
        let h, k = {},
            _ = null;
        for (let t = 0; t < g.length && (h = g[t], k = n[h] || {}, _ = k[s], !v(_)); t++) te(e, s, h, 0, "number format");
        if (!v(_) || !d(h)) return r ? -1 : s;
        let y = `${h}__${s}`;
        l(f) || (y = `${y}__${JSON.stringify(f)}`);
        let F = o.get(y);
    ...
    function ke(...e) {
        ...
        if (!o(t)) throw Error(14);
        const c = t;
        return d(n) ? s.key = n : v(n) && (s = n), d(r) ? s.locale = r : v(r) && (l = r), v(a) && (l = a), [s.key || "", c, s, l]
    }
    ...
    function xe(e) {
        return (n, r, a, o) => e(r, a, t.getCurrentInstance() || void 0, o)
    }
    ...
    function Me(e, t) {
        ...
        for (const n in e) m(e, n) && (Ce(e[n]) || Ce(t[n]) ? t[n] = e[n] : Me(e[n], t[n]))
    }
    ...
    function $e(e = {}) {
        ...
        let a = !b(e.inheritLocale) || e.inheritLocale;
        const l = t.ref(n && a ? n.locale.value : d(e.locale) ? e.locale : "en-US"),
            c = t.ref(n && a ? n.fallbackLocale.value : d(e.fallbackLocale) || p(e.fallbackLocale) || v(e.fallbackLocale) || !1 === e.fallbackLocale ? e.fallbackLocale : l.value),
            i = t.ref(Pe(l.value, e)),
            f = t.ref(v(e.datetimeFormats) ? e.datetimeFormats : {
                [l.value]: {}
            }),
            m = t.ref(v(e.numberFormats) ? e.numberFormats : {
                [l.value]: {}
            });
        let k = n ? n.missingWarn : !b(e.missingWarn) && !s(e.missingWarn) || e.missingWarn,
            ...
            C = !!e.escapeParameter;
        const M = n ? n.modifiers : v(e.modifiers) ? e.modifiers : {};
        let $, O = e.pluralRules || n && n.pluralRules;
        $ = ee({
            version: ve,
            locale: l.value,
        ...
        const I = t.computed({
            ...
            N = t.computed((() => i.value)),
            S = t.computed((() => f.value)),
        ...
        function H(...e) {
            return j((t => fe(t, ...e)), (() => pe(...e)), 0, (t => t.t(...e)), (e => e), (e => d(e)))
        }
        const R = {
            normalize: function(e) {
                return e.map((e => d(e) ? t.createVNode(t.Text, null, e, 0) : e))
            },
            interpolate: e => e,
            type: "vnode"
        };
        ...
        Te++, n && (t.watch(n.locale, (e => {
            a && (l.value = e, $.locale = e, se($, l.value, c.value))
        })), t.watch(n.fallbackLocale, (e => {
        ...
        return {
            ...
            d: function(...e) {
                return j((t => ge(t, ...e)), (() => de(...e)), 0, (t => t.d(...e)), (() => ""), (e => d(e)))
            },
            n: function(...e) {
                return j((t => he(t, ...e)), (() => ke(...e)), 0, (t => t.n(...e)), (() => ""), (e => d(e)))
            },
            te: function(e, t) {
                return null !== x(D(d(t) ? t : l.value), e)
            },
            tm: function(e) {
                const t = function(e) {
                    let t = null;
                    const n = ne($, c.value, l.value);
                    for (let r = 0; r < n.length; r++) {
                        const a = x(i.value[n[r]] || {}, e);
                        if (null != a) {
                            t = a;
                            break
                        }
            ...
            [ye]: function(...e) {
                return j((t => {
                    ...
                    const r = t;
                    try {
                        r.processor = R, n = fe(r, ...e)
                    } finally {
                        r.processor = null
                    }
                    return n
                }), (() => pe(...e)), 0, (t => t[ye](...e)), (e => [t.createVNode(t.Text, null, e, 0)]), (e => p(e)))
            },
            [Le]: function(...e) {
                return j((t => he(t, ...e)), (() => ke(...e)), 0, (t => t[Le](...e)), (() => []), (e => d(e) || p(e)))
            },
            [Fe]: function(...e) {
                return j((t => ge(t, ...e)), (() => de(...e)), 0, (t => t[Fe](...e)), (() => []), (e => d(e) || p(e)))
            },
            [we]: function(e) {
                O = e, $.pluralRules = O
            }
    ...
    function Oe(e = {}) {
        const t = $e(function(e) {
                const t = d(e.locale) ? e.locale : "en-US",
                    n = d(e.fallbackLocale) || p(e.fallbackLocale) || v(e.fallbackLocale) || !1 === e.fallbackLocale ? e.fallbackLocale : t,
                    ...
                    h = !d(e.warnHtmlInMessage) || "off" !== e.warnHtmlInMessage,
                    k = !!e.escapeParameterHtml,
                    _ = !b(e.sync) || e.sync;
                let y = e.messages;
                if (v(e.sharedMessages)) {
                    const t = e.sharedMessages;
                    y = Object.keys(t).reduce(((e, n) => {
                        const r = e[n] || (e[n] = {});
                        return u(r, t[n]), e
                    }), y || {})
                }
            ...
            n = {
                ...
                t(...e) {
                    ...
                    let s = null,
                        l = null;
                    if (!d(n)) throw Error(15);
                    const c = n;
                    return d(r) ? o.locale = r : p(r) ? s = r : v(r) && (l = r), p(a) ? s = a : v(a) && (l = a), t.t(c, s || l || {}, o)
                },
                rt: (...e) => t.rt(...e),
                tc(...e) {
                    const [n, r, a] = e, s = {
                    ...
                    if (!d(n)) throw Error(15);
                    const u = n;
                    return d(r) ? s.locale = r : o(r) ? s.plural = r : p(r) ? l = r : v(r) && (c = r), d(a) ? s.locale = a : p(a) ? l = a : v(a) && (c = a), t.t(u, l || c || {}, s)
                },
                te: (e, n) => t.te(e, n),
                tm: e => t.tm(e),
        ...
        We = {
            ...
            setup(e, n) {
                const {
                    ...
                    useScope: e.scope
                }), s = Object.keys(r).filter((e => "_" !== e));
                return () => {
                    const r = {};
                    e.locale && (r.locale = e.locale), void 0 !== e.plural && (r.plural = d(e.plural) ? +e.plural : e.plural);
                    const l = function({
                            slots: e
                        }, t) {
                        ...
                        i = u({}, a);
                    return d(e.tag) || h(e.tag) ? t.h(e.tag, i, c) : t.h(t.Fragment, i, c)
                }
            }
        };
    ...
    function Ne(e, n, r, a) {
        ...
        return () => {
            ...
            let l = {};
            e.locale && (n.locale = e.locale), d(e.format) ? n.key = e.format : h(e.format) && (d(e.format.key) && (n.key = e.format.key), l = Object.keys(e.format).reduce(((t, n) => r.includes(n) ? u({}, t, {
                [n]: e.format[n]
            }) : t), {}));
            const c = a(e.value, n, l);
            let i = [n.key];
            p(c) ? i = c.map(((e, t) => {
                const n = o[e.type];
                return n ? n({
            ...
            const f = u({}, s);
            return d(e.tag) || h(e.tag) ? t.h(e.tag, f, i) : t.h(t.Fragment, f, i)
        }
    }
    const Se = ["localeMatcher", "style", "unit", "unitDisplay", "currency", "currencyDisplay", "useGrouping", "numberingSystem", "minimumIntegerDigits", "minimumFractionDigits", "maximumFractionDigits", "minimumSignificantDigits", "maximumSignificantDigits", "notation", "formatMatcher"],
        Ee = {
            name: "i18n-n",
            props: u({
                value: {
    ...
    function Ae(e = {}) {
        ...
        const r = t.inject(n.appContext.app.__VUE_I18N_SYMBOL__);
        if (!r) throw Error(22);
        const a = "composition" === r.mode ? r.global : r.global.__composer,
            o = l(e) ? "__i18n" in n.type ? "local" : "global" : e.useScope ? e.useScope : "local";
        if ("global" === o) {
            let t = h(e.messages) ? e.messages : {};
            "__i18nGlobal" in n.type && (t = Pe(a.locale.value, {
                messages: t,
                __i18n: n.type.__i18nGlobal
            }));
            const r = Object.keys(t);
            if (r.length && r.forEach((e => {
                    a.mergeLocaleMessage(e, t[e])
                })), h(e.datetimeFormats)) {
        ...
        const s = r;
        let c = s.__getInstance(n);
        if (null == c) {
            const r = n.type,
                o = u({}, e);
            r.__i18n && (o.__i18n = r.__i18n), a && (o.__root = a), c = $e(o),
                function(e, n, r) {
                    t.onMounted((() => {}), n), t.onUnmounted((() => {
    ...
    return Q = function(e, t = {}) {
        {
            ...
            const {
                code: s
            } = Z(e, t), l = new Function(`return ${s}`)();
            return a ? l : ce[n] = l
        }
    }, e.DatetimeFormat = He, e.NumberFormat = Ee, e.Translation = We, e.VERSION = ve, e.createI18n = function(e = {}) {
        const n = !b(e.legacy) || e.legacy,
            a = !!e.globalInjection,
            o = new Map,
            s = n ? Oe(e) : $e(e),
            l = r(""),
            c = {
                ...
                async install(e, ...r) {
                    e.__VUE_I18N_SYMBOL__ = l, e.provide(e.__VUE_I18N_SYMBOL__, c), !n && a && function(e, n) {
                            ...
                            })), e.config.globalProperties.$i18n = r, ze.forEach((t => {
                        ...
                        }(e, c, ...r), n && e.mixin(function(e, n, r) {
                            return {
                                beforeCreate() {
                                    ...
                                    if (o.i18n) {
                                        const t = o.i18n;
                                        o.__i18n && (t.__i18n = o.__i18n), t.__root = n, this.$i18n = this === this.$root ? De(e, t) : Oe(t)
                                    } else this.$i18n = o.__i18n ? this === this.$root ? De(e, o) : Oe({
                                        __i18n: o.__i18n,
                                        __root: n
                                    }) : e;
                                    e.__onComponentInstanceCreated(this.$i18n), r.__setInstance(a, this.$i18n), this.$t = (...e) => this.$i18n.t(...e), this.$rt = (...e) => this.$i18n.rt(...e), this.$tc = (...e) => this.$i18n.tc(...e), this.$te = (e, t) => this.$i18n.te(e, t), this.$d = (...e) => this.$i18n.d(...e), this.$n = (...e) => this.$i18n.n(...e), this.$tm = e => this.$i18n.tm(e)
                                },
                                mounted() {},
                                beforeUnmount() {
